...
namespace Anki
{
    ...
    {
        private const string _default_deck_filename= "deck.txt";
        ...
        public AnkiGame(string datastoredir = null)
        {
          
            _persistance = new Persistance<AnkiSessionData>(_default_deck_filename, datastoredir);
        }
